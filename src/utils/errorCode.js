export default {
  configFileError: {
    code: 1491,
    messages: [
      "Kiểm tra cấu hình site ở file xảy ra lỗi",
      "Verify file config fail.",
    ],
  },
  syncFileError: {
    code: 1492,
  ...
  getInfoAttributes: {
    code: 1407,
    messages: [
      "Thuộc tính phải là một mảng",
      "Attributes must be array of fields.",
    ],
  },
  getInfoError: {
    code: 1415,
  ...
  getInfoNoPermision: {
    code: 1416,
    messages: [
      "Bạn không có quyền đối với nội dung này",
      "You not have permision to access this resource.",
    ],
  },
  permisionInfoError: {
    code: 1416,
    messages: [
      "Quá trình kiểm tra quyền truy cập dữ liệu bị lỗi",
      "Error when check permision.",
    ],
  },
  ...
  bodyError: {
    code: 1407,
    messages: [
      "Định dạng gửi đi không đúng",
      "Format request body is invalid.",
    ],
  },
  crudNoProcess: {
    code: 1409,
  ...
  deleteSuccess: {
    code: 1412,
    messages: [
      "Xóa thành công, nhưng có lỗi xảy ra.",
      "Delete successful. But something error on server.",
    ],
  },
  ...
  deleteId: {
    code: 1414,
    messages: [
      "Trường [id] bị thiếu hoặc sai định dạng",
  ...
  sslError: {
    code: 1416,
    messages: [
      "Key và giá trị Certificate không khớp",
      "Verify key and certificate ssl false.",
    ],
  },
